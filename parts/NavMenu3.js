...
function Nav() {
    ...
    <Transition
        ...
        >
    <Menu.Items >
      <div className="text-black font-medium filter drop-shadow-lg bg-white z-30 absolute -left-48 transform    p-2 rounded flex flex-col text-sm w-max">
        <a
            className=""
            href="/about"
          >
        ...
        <div className="px-2.5 py-1.5 rounded-md hover:bg-slate-200 ">
        Events for Schools, Businesses & More        </div>
        </a>
